...
<template>
    ...
    <button type="button" class="px-6
                  ...
                  transition
                  duration-150
                  ease-in-out" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="driver1 = []">
              {{ buttonTitle }}
    </button>
    <!-- Modal -->
          ...
          <div class="modal-body relative p-4">
            <div class="flex flex-col items-start text-xl">
              <div v-for="(driver, index) in allDrivers" :key="index">
                ...
                <!-- <input type="checkbox" :id="driver" :value="index" @change="$emit()"> -->
